...
function Register3() {
  ...
  useEffect(()=>{
    const GetTheEmail = cookies.getItem('emailID')
    Setemail(GetTheEmail)
  },[])
    ...
    0-3.49v-116.68a16.4 16.4 0 0 0 -8.24-14.36zm42.49-63.95c-.75-.46-2.06-1.25-3-1.79l-101-58.34a16.46 16.46 0 0
     0 -16.59 0l-123.31 71.2v-49.3a1.53 1.53 0 0 1 .61-1.31l102.1-58.9a95.07 95.07 0 0 1 141.19 98.44zm-267.11
      ...
      58.34a16.41 16.41 0 0 0 -8.3 14.36zm23.19-50 54.92-31.72 54.92 31.7v63.42l-54.92 31.7-54.92-31.7z"></path></svg>
        ...
        <div className="form-body" onSubmit={HandleUserData}>
        <form className="FORms">
    <p className="title">Tell us about you  </p>
    
        <div className="flex">
       
            <input  placeholder="First name" type="text" className="input" onChange={(e)=>SetFirst(e.target.value)}  />
             <input  placeholder="Last name" type="text" className="input" onChange={(e)=>SetLast(e.target.value)}  />
    </div>     
        <input  placeholder="Email" type="email" className="input" value={Email}  readOnly={true}/>
        <input  placeholder="Password" type="password" className="input" onChange={(e)=>SetPass(e.target.value)}    /> 
    <button className="SEND-DATA">Submit</button>
